...
for fnum=1:numel(infilename)
	...
	fprintf('%s'': Converting ''%s''...',mfilename,FileNameShort)
	...
	for segCnt=1:NumOfSeg
		...
		if kTocMetaData
			...
			for q=1:numObjInSeg
				...
				obname=convertToText(fread(fid,obLength,'uint8'))';	%Get the objects name
				...
				if rawdataindex==0
					% Use index information of the last segement of this object
